...
<body>
<div>
	<div style="width:10%;float:left"><img src="logo.jpg"  align="left"width="100" height="100"></div>
	<div style="width:80%;float:left"><center><h1 style="margin-top:25px";><b>KL UNIVERSITY</h1></center></div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form name="my-form" onsubmit="return validform()" action="insertNewResult.jsp" method="">
                                ...
                                <div class="form-group row">
                                    <label for="email_address" class="col-md-4 col-form-label text-md-right">ESD</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="user_name" class="col-md-4 col-form-label text-md-right">Mathematical Programming</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="phone_number" class="col-md-4 col-form-label text-md-right">DWDM</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="present_address" class="col-md-4 col-form-label text-md-right">Flask</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                 ...
                                 <div class="form-group row">
                                    <label for="permanent_address" class="col-md-4 col-form-label text-md-right">c</label>
                                    <div class="col-md-6">
                                 ...
                                 <div class="form-group row">
                                    <label for="permanent_address" class="col-md-4 col-form-label text-md-right">Core Java</label>
                                    <div class="col-md-6">
...
<section>
  ...
  <div class="tbl-content">
    ...
    <hr class="new1">
  <center><h5>Note: Any errors occur then KL University.
Designed & Developed by Shreya,Rishitha</h5></center>
  <hr class="new1">
<center><h5>All Right Reserved @SR</h5></center> 
  <hr class="new1">
<br>
</body>
</html>